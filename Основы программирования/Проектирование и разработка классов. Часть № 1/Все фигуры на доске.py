    ...
    def is_under_attack(self, row, col, color):
        ...
        for row_i in range(7, -1, -1):
            for col_j in range(8):
                if self.field[row_i][col_j] is not None:
                    piece = self.field[row_i][col_j]
